...
class BookInfo(models.Model): # 定義BookInfo並繼承 models.Model
    """ 定義書籍Model """
...
class RoleInfo(models.Model):
    ...
    book = models.ForeignKey(BookInfo, on_delete=models.PROTECT) # [on_delete] ref. https://www.coder.work/article/3185936
