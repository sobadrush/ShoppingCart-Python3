...
from Book.views import testRedirectToBookPage, testGetBookInfoJson, toIndexPage, getAllBooks
...
urlpatterns = [
    ...
    path("toGetAllBooks", getAllBooks), # 網址列敲: http://127.0.0.1:8000/book/getAllBooks 會轉到 testRedirectToBookPage 函數
